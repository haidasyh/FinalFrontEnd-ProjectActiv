        ...
        <div class="grid grid-cols-4 gap-6">
            <a href="category.html" class="card">
                <div class="flex items-center h-full rounded-3xl p-5 pr-1 gap-3 bg-white">
                    <img src="{{asset("assets/images/icons/code-bg.svg")}}" class="w-[56px] h-[56px] flex shrink-0"
                        alt="icon">
            ...
            <a href="category.html" class="card">
                <div class="flex items-center h-full rounded-3xl p-5 pr-1 gap-3 bg-white">
                    <img src="{{asset("assets/images/icons/wallet-3-bg.svg")}}" class="w-[56px] h-[56px] flex shrink-0"
                        alt="icon">
                    <div class="flex flex-col gap-[2px] overflow-hidden">
            ...
            <a href="category.html" class="card">
                <div class="flex items-center h-full rounded-3xl p-5 pr-1 gap-3 bg-white">
                    <img src="{{asset("assets/images/icons/musicnote-bg.svg")}}" class="w-[56px] h-[56px] flex shrink-0"
                        alt="icon">
                    <div class="flex flex-col gap-[2px] overflow-hidden">
            ...
            <a href="category.html" class="card">
                <div class="flex items-center h-full rounded-3xl p-5 pr-1 gap-3 bg-white">
                    <img src="{{asset("assets/images/icons/berzier-bg.svg")}}" class="w-[56px] h-[56px] flex shrink-0"
                        alt="icon">
                    <div class="flex flex-col gap-[2px] overflow-hidden">
...
<section id="Trending" class="w-full max-w-[1280px] mx-auto px-[52px] mt-[100px]">
    <div class="flex flex-col gap-8">
        <div class="flex items-center justify-between">
            <h2 class="font-Neue-Plak-bold text-[32px] leading-[44.54px] capitalize">Highly sought-after 🔥<br>workshops
                are trending </h2>
            <a href="#" class="flex items-center rounded-full py-4 px-6 h-[56px] gap-3 bg-aktiv-orange">
                <span class="font-semibold text-white">See All</span>
                <span
        ...
        <div class="grid grid-cols-3 gap-6">
            @forelse ($newWorkshops as $itemNewWorkshop)
                <a href="{{route('front.details', $itemNewWorkshop->slug)}}" class="cahrd">
                        ...
                        <div class="flex flex-col gap-[18px]">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex flex-col gap-[2px]">
                                    <p class="font-semibold text-lg leading-[27px]">{{$itemNewWorkshop->instructor->name}}
                                    </p>
                            ...
                            <div class="thumbnail-container relative h-[200px] rounded-xl bg-[#D9D9D9] overflow-hidden">
                                <img src="{{Storage::url($itemNewWorkshop->thumbnail)}}" class="w-full h-full object-cover"
                                    alt="thumbnail">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex items-center gap-1">
                                        <img src="{{asset("assets/images/icons/timer.svg")}}" class="w-6 h-6 flex shrink-0"
                                            alt="icon">
                                        <span
                                            class="font-medium text-aktiv-grey">{{$itemNewWorkshop->started_at->format("h:i, A")}}</span>
                                    </div>
                                </div>
                ...
                <div class="flex flex-col h-full justify-between rounded-3xl p-6 gap-9 bg-white">
                    <div class="flex flex-col gap-[18px]">
                        ...
                        <div class="card-detail flex flex-col gap-2">
                            ...
                            <h3 class="title min-h-[56px] font-semibold text-xl line-clamp-2 hover:line-clamp-none">
                                Mastering HTML & CSS: Intensive Workshop for Beginners</h3>
                ...
                <div class="flex flex-col h-full justify-between rounded-3xl p-6 gap-9 bg-white">
                    <div class="flex flex-col gap-[18px]">
                        ...
                        <div class="card-detail flex flex-col gap-2">
                            ...
                            <h3 class="title min-h-[56px] font-semibold text-xl line-clamp-2 hover:line-clamp-none">
                                UX/UI Design: Creating Amazing User Experiences</h3>
            ...
            <a href="details.html" class="card">
                <div class="flex flex-col h-full justify-between rounded-3xl p-6 gap-9 bg-white">
                    <div class="flex flex-col gap-[18px]">
                        ...
                        <div class="thumbnail-container relative h-[200px] rounded-xl bg-[#D9D9D9] overflow-hidden">
                            <img src="{{asset("assets/images/thumbnails/thumbnail4.png")}}"
                                class="w-full h-full object-cover" alt="thumbnail">
                            <div
                                class="absolute top-3 left-3 flex items-center rounded-full py-3 px-5 gap-1 bg-aktiv-green text-white z-10">
                                <img src="{{asset("assets/images/icons/medal-star.svg")}}" class="w-6 h-6" alt="icon">
                        ...
                        <div class="card-detail flex flex-col gap-2">
                            ...
                            <h3 class="title min-h-[56px] font-semibold text-xl line-clamp-2 hover:line-clamp-none">
                                Creativity in Music: Developing New Ideas and Inspiration</h3>
            ...
            <a href="details.html" class="card">`
                <div class="flex flex-col h-full justify-between rounded-3xl p-6 gap-9 bg-white">
                    <div class="flex flex-col gap-[18px]">
                        ...
                        <div class="thumbnail-container relative h-[200px] rounded-xl bg-[#D9D9D9] overflow-hidden">
                            <img src="{{asset("assets/images/thumbnails/thumbnail5.png")}}"
                                class="w-full h-full object-cover" alt="thumbnail">
                            <div
                                class="absolute top-3 left-3 flex items-center rounded-full py-3 px-5 gap-1 bg-aktiv-green text-white z-10">
                                <img src="{{asset("assets/images/icons/medal-star.svg")}}" class="w-6 h-6" alt="icon">
                        ...
                        <div class="card-detail flex flex-col gap-2">
                            ...
                            <h3 class="title min-h-[56px] font-semibold text-xl line-clamp-2 hover:line-clamp-none">
                                Building Confidence and Mastering Sales Techniques: A Complete Guide for Sales
                                Professionals to Achieve Outstanding Results</h3>
            ...
            <a href="details.html" class="card">
                <div class="flex flex-col h-full justify-between rounded-3xl p-6 gap-9 bg-white">
                    <div class="flex flex-col gap-[18px]">
                        <div class="flex items-center gap-3">
                            <div class="w-16 h-16 rounded-full flex shrink-0 overflow-hidden">
                                <img src="{{asset("assets/images/photos/photo6.png")}}"
                                    class="w-full h-full object-cover" alt="avatar">
                            </div>
                            <div class="flex flex-col gap-[2px]">
                        ...
                        <div class="thumbnail-container relative h-[200px] rounded-xl bg-[#D9D9D9] overflow-hidden">
                            <img src="{{asset("assets/images/thumbnails/thumbnail6.png")}}"
                                class="w-full h-full object-cover" alt="thumbnail">
                            <div
                                class="absolute top-3 left-3 flex items-center rounded-full py-3 px-5 gap-1 bg-aktiv-green text-white z-10">
                                <img src="{{asset("assets/images/icons/medal-star.svg")}}" class="w-6 h-6" alt="icon">
                        ...
                        <div class="card-detail flex flex-col gap-2">
                            ...
                            <h3 class="title min-h-[56px] font-semibold text-xl line-clamp-2 hover:line-clamp-none">
                                Managing Stress and Mental Health in the Music Industry</h3>
                            <p class="font-medium text-aktiv-grey">Self Improvement</p>
                        </div>
                    </div>
                    <div class="flex items-center justify-between">
...
<div class="w-full py-[52px] bg-whi
te mt-[100px]">
...
<div id="Join-Now" class="relative w-full overflow-hidden">
    ...
    <div
        ...
        <div class="flex flex-col justify-center p-[90px] pr-[60px] gap-8">
            <p class="rounded-full w-fit py-3 px-8 font-semibold text-aktiv-blue bg-[#DFEFFF]">What are you waiting for?
                Join now 🔥 </p>
